...
If your project was set up with the shadcn CLI (`bunx shadcn@latest init`), you already have `shimmer`. It ships with the `shadcn` package, which the CLI imports in your global CSS file.
