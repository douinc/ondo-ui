...
| `variant`       | `"default" \| "success"`     | `"default"`    | The color variant shared by active and completed steps. |
| `activeVariant` | `"default" \| "success"`     | `variant`      | Optional color override for the active step only.       |
