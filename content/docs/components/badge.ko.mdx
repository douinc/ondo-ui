...
```tsx
<Badge variant="default | secondary | muted | brand | info | success | warning | destructive | outline | ghost">Badge</Badge>
```
...
| `variant`   | `"default" \| "secondary" \| "muted" \| "brand" \| "info" \| "success" \| "warning" \| "destructive" \| "outline" \| "ghost" \| "link"` | `"default"` |
| `className` | `string`                                                                      | -           |
