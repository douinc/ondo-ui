...
function heading<T extends "h1" | "h2" | "h3" | "h4" | "h5" | "h6">(Tag: T) {
  function Heading({ children, id, ...props }: React.ComponentProps<T>) {
...
function MdxAnchor({
  ...
  href = "",
  ...props
}: React.ComponentProps<"a"> & { lang: string }) {
  if (!href.startsWith("/")) {
...
export function getMdxComponents(lang: string) {
  return {
    ...mdxComponents,
    a: (props: React.ComponentProps<"a">) => <MdxAnchor lang={lang} {...props} />,
  }
}
